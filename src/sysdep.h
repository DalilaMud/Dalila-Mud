...
/* #ifndef fprintf	Commentato: in alcuni compilatori e' causa di ridefinizione diversa.
      int fprintf();	Ad ogni modo, non esiste un compilatore che non ce l'abbia, quindi
   #endif		non c'e' problema... */
